    ...
    },
    {
      ...
      items: [
        'module-4-vla-integration/index',
        {
          ...
          label: 'Chapters',
          items: [
            'module-4-vla-integration/voice-to-action-with-openai-whisper',
            'module-4-vla-integration/vision-language-planning-llms-ros2',
            'module-4-vla-integration/capstone-autonomous-humanoid'
          ],
        }
      ],
    },
